...
const contractABI = require("../artifacts/contracts/Llamaindexagent.sol/Llamaindexagent.json").abi;

program
    .name("llamaindexagent-cli")
    .description("CLI tool for Llamaindexagent smart contract")
    .version("1.0.0");
